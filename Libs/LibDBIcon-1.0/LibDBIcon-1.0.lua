...
lib.tooltip =
  lib.tooltip or CreateFrame('GameTooltip', 'LibDBIconTooltip', UIParent, 'GameTooltipTemplate')
...
local function getAnchors(frame)
  ...
  local hhalf =
    (x > UIParent:GetWidth() * 2 / 3) and 'RIGHT' or (x < UIParent:GetWidth() / 3) and 'LEFT' or ''
